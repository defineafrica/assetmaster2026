...
return [
    ...
    'login' => 'Είσοδος',
    'login_first_admin' => 'Συνδεθείτε στη νέα σας εγκατάσταση AssetMaster χρησιμοποιώντας τα παρακάτω διαπιστευτήρια:',
    ...
    'serial' => 'Σειριακός',
    'snipe_webhook_test' => 'AssetMaster Δοκιμή Ολοκλήρωσης',
    'snipe_webhook_summary' => 'Σύνοψη Δοκιμής Ενσωμάτωσης AssetMaster',
    'supplier' => 'Προμηθευτές',
    'tag' => 'Ετικέτα',
    'test_email' => 'Έλεγχος email για AssetMaster',
    'test_mail_text' => 'Πρόκειται για μια δοκιμή από το σύστημα διαχείρισης περιουσιακών στοιχείων της AssetMaster. Αν το έχετε, το mail λειτουργεί :)',
    ...
    'your_credentials' => 'Τα διαπιστευτήρια σας AssetMaster',
