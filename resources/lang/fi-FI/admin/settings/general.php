...
return [
    ...
    'show_images_in_email_help'   => 'Poista tämä valinta, jos AssetMaster asennus on toteutettu VPN: n avulla tai suljetussa verkossa, koska sähköposteissa käytetyt kuvat eivät voi latautua näkyviin sähköposteissa.',
    ...
    'snipe_version'  			=> 'AssetMaster versio',
    'support_footer'            => 'Tuki-alatunnisteen linkit ',
    'support_footer_help'       => 'Määrittele, kuka voi nähdä linkit AssetMaster tukipalvelun tietoihin ja käyttöohjeeseen',
    'version_footer'            => 'Versio alatunnisteessa ',
    'version_footer_help'       => 'Määrittele, kuka näkee AssetMaster järjestelmän version ja käännöksen numeron.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'k',
    'show_url_in_emails'                => 'Linkki AssetMaster: hen sähköposteissa',
    'show_url_in_emails_help_text'      => 'Poista tämä valintaruutu, jos et halua linkata takaisin AssetMaster-asennukseen sähköpostin alatunnisteisiin. Hyödyllinen, jos useimmat käyttäjät eivät koskaan kirjaudu sisään.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Tämä yrittää poistaa välimuistissa olevat viivakoodit. Tätä käytetään yleensä vain, jos viivakoodisi asetukset ovat muuttuneet, tai jos AssetMaster URL on muuttunut. Viivakoodit luodaan uudelleen, kun niitä käytetään seuraavaksi.',
