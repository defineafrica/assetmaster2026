...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'Ako je ovdje upisan url, korisnici će biti biti preusmjereni na taj URL nakon što se odjave iz AssetMaster-a. Ovo je korisno radi ispravnog zatvaranja korisničkog session-a kod vašeg pružatelja autentifikacije.',
    ...
    'show_images_in_email_help'   => 'Isključite ovaj okvir ako je vaša AssetMaster instalacija iza VPN ili zatvorene mreže, a korisnici izvan mreže neće moći učitati slike poslužene s ove instalacije u njihovu e-poštu.',
    ...
    'snipe_version'  			=> 'AssetMaster verzija',
    'support_footer'            => 'Podrška poveznica u podnožju ',
    'support_footer_help'       => 'Navedite tko vidi poveznice na informacije o AssetMaster podršci i korisničkom priručniku',
    'version_footer'            => 'Verzija u podnožju ',
    'version_footer_help'       => 'Odredite tko može vidjeti AssetMaster verziju i build broj.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Veza na AssetMaster u e-pošti',
    'show_url_in_emails_help_text'      => 'Poništite potvrdni okvir ako ne želite povezati vašu AssetMaster instalaciju u svoje podnožje e-pošte. Korisno je ako se većina korisnika nikada ne prijavljuje.',
    'text_pt'        => 'PT',
