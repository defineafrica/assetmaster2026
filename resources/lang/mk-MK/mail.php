...
return [
    ...
    'login' => 'Најава',
    'login_first_admin' => 'Влезете во новата инсталација на AssetMaster користејќи ги ингеренциите подолу:',
    ...
    'serial' => 'Сериски',
    'snipe_webhook_test' => 'AssetMaster Тест за интеграција',
    'snipe_webhook_summary' => 'AssetMaster Резиме на тест за интеграција',
    'supplier' => 'Добавувач',
    'tag' => 'Таг',
    'test_email' => 'Тест е-пошта од AssetMaster',
    'test_mail_text' => 'Ова е тест од AssetMaster Системот за управување со основни средства. Ако го добивте ова, е-поштата работи :)',
