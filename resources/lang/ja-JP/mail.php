...
return [
    ...
    'login' => 'ログイン',
    'login_first_admin' => '以下の新しいログイン情報を使用して、AssetMasterにログインします。',
    ...
    'serial' => 'シリアル',
    'snipe_webhook_test' => 'AssetMaster 統合テスト',
    'snipe_webhook_summary' => 'AssetMaster 統合テストの概要',
    'supplier' => '仕入先',
    'tag' => 'タグ',
    'test_email' => 'AssetMasterからのテストメール',
    'test_mail_text' => 'これはAssetMaster資産管理システムのテストです。あなたがこれを読めているなら、メール機能は動作しています:)',
    ...
    'your_credentials' => 'AssetMaster クレデンシャル',
