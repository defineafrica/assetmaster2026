...
return [
    ...
    'login' => 'الدخول',
    'login_first_admin' => 'قم بتسجيل الدخول إلى التثبيت الجديد من AssetMaster باستخدام البيانات أدناه:',
    ...
    'test_mail_text' => 'يعتبر هذا اختبارا من نظام إدارة الأصول AssetMaster. إذا كنت حصلت على هذا، فان البريد يعمل :)',
