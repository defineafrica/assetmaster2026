...
return [
    ...
    'login' => '登录',
    'login_first_admin' => '请使用以下凭据登录新安装的 AssetMaster：',
    ...
    'serial' => '序列号',
    'snipe_webhook_test' => 'AssetMaster 集成测试',
    'snipe_webhook_summary' => 'AssetMaster 集成测试摘要',
    'supplier' => '供应商',
    'tag' => '标签',
    'test_email' => 'AssetMaster 测试邮件',
    'test_mail_text' => '这是一封 AssetMaster 资产管理系统的测试电子邮件，如果您收到，表示邮件通知正常运作 :)',
    ...
    'welcome_to' => '欢迎来到 :web！',
    'your_assets' => '查看您的资产',
    'your_credentials' => '您的 AssetMaster 登录凭据',
    'mail_sent' => '邮件发送成功！',
];
