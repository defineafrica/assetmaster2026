...
return [
    ...
    'general_help_text' => 'Користувацькі поля зберігають додаткову інформацію, не охоплену стандартними полями активів. <a href="https://assetmaster.readme.io/docs/custom-fields#/"><i class="fa fa-external-link"></i></a>.',
];
