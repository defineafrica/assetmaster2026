...
return [
    ...
    'load_remote_help_text'		=> 'Премахнете отметката от това квадратче, ако вашата инсталация не може да зареди скриптове от външен интернет. Това ще попречи на AssetMaster да се опита да зареди аватари от Gravatar или други външни източници.',
    'login'                     => 'Опити за вход',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ако уеб адреса е вписън тук, потребителите ще бъдат препратени към този URL след като излязат от AssetMaster. Това е препоръчително за да се затвори сесията от доставчика на удостоверения правилно.',
    ...
    'snipe_version'  			=> 'AssetMaster версия',
    'support_footer'            => 'Връзки към Snipe-it поддръжката във футъра',
    'support_footer_help'       => 'Указва визуализацията на връзки към поддръжката на AssetMaster и потребителската документация',
    'version_footer'            => 'Версия в долен колонтитул ',
    'version_footer_help'       => 'Определя кой ще вижда AssetMaster версията и номера на компилация.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Връзка към AssetMaster в имейли',
    'show_url_in_emails_help_text'      => 'Премахнете отметката от тази кутийка, ако не желаете да свържете обратно към вашата AssetMaster инсталация в досиетата ви за електронна поща. Полезно, ако повечето от вашите потребители никога не влизат в системата.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Това ще изтрие кеша на баркодовете. Това обикновено се използва при промяна на баркод настройките или при промяна на AssetMaster URL адреса. Баркодовете ще бъдат генерирани отново.',
