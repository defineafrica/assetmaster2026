...
return [
    ...
    'login' => 'Логин',
    'login_first_admin' => 'Влезте в своята AssetMaster инсталация използвайки данните по-долу:',
    ...
    'snipe_webhook_test' => 'AssetMaster Интеграционен тест',
    'snipe_webhook_summary' => 'AssetMaster Резюме на интеграционния тест',
    'supplier' => 'Доставчик',
    'tag' => 'Етикет',
    'test_email' => 'Тест Email от AssetMaster',
    'test_mail_text' => 'Това е тест от AssetMaster система за управление на активи. Ако сте получили това, email-а работи :)',
    ...
    'your_credentials' => 'Вашите идентификационни данни за AssetMaster',
