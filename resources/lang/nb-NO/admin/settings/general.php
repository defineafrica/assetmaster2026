...
Linjeskift, topptekst, bilder, osv. kan føre til uventede resultater.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Hvis en URL angis her blir brukerne videresendt til denne URLen etter utlogging fra AssetMaster. Dette er nyttig for korrekt lukking av autentiseringssesjoner hos din autentiseringsleverandør.',
    ...
    'show_images_in_email_help'   => 'Fjern merkingen i denne boksen hvis AssetMaster-installasjonen er bak en VPN eller et lukket nettverk og brukere utenfor nettverket ikke vil kunne laste bilder servert fra denne installasjonen i e-posten.',
    ...
    'snipe_version'  			=> 'AssetMaster-versjon',
    'support_footer'            => 'Støtte Footer Lenker ',
    'support_footer_help'       => 'Angi hvem som kan se lenker til AssetMaster supportinformasjon og brukermanual',
    'version_footer'            => 'Versjon i Footer ',
    'version_footer_help'       => 'Angi hvem som kan se AssetMaster versjon og build-nummer.',
    ...
    'width_w'        => 'b',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link til AssetMaster i e-post',
    'show_url_in_emails_help_text'      => 'Fjern markeringen i denne boksen hvis du ikke vil koble tilbake til AssetMaster-installasjonen i e-postboksene dine. Nyttig hvis de fleste av brukerne aldri logger inn.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Dette forsøker å slette hurtigbufrede strekkoder. Dette vil vanligvis bare bli brukt hvis strekkodeinnstillingene dine er endret, eller hvis AssetMaster adressen er endret. Strekkoder genereres på nytt når de blir åpnet neste gang.',
