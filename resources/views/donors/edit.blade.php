@extends('layouts/edit-form', [
    'createText' => trans('admin/donors/table.create') ,
    'updateText' => trans('admin/donors/table.update'),
    'helpPosition'  => 'right',
    'helpText' => trans('help.donors'),
    'formAction' => (isset($item->id)) ? route('donors.update', ['donor' => $item->id]) : route('donors.store'),
])

@section('inputFields')
@include ('partials.forms.edit.name', ['translated_name' => trans('admin/donors/table.name')])
@include ('partials.forms.edit.phone')
@include ('partials.forms.edit.fax')
@include ('partials.forms.edit.email')
@include ('partials.forms.edit.image-upload', ['image_path' => app('donors_upload_path')])
