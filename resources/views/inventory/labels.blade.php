...
@foreach ($assets as $asset)
    ...
    <div class="label">
        ...
        @if ($settings->qr_code=='1')
            <div class="qr_img">
                <img src="{{ config('app.url') }}/inventories/{{ $asset->id }}/qr_code" class="qr_img">
            </div>
        @endif
        ...
        <div class="qr_text">
            ...
            @endif
            @if (($settings->labels_display_tag=='1') && ($asset->inventory_tag!=''))
                <div class="pull-left">
                    T: {{ $asset->inventory_tag }}
                </div>
            @endif
        ...
        @if ((($settings->alt_barcode_enabled=='1') && $settings->label2_1d_type!=''))
            <div class="barcode_container">
                <img src="{{ config('app.url') }}/inventories/{{ $asset->id }}/barcode" class="barcode">
            </div>
        @endif
