    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-default">
                ...
                <form method="POST" action="{{ route('inventory.audit.store', $inventory) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <!-- Update location -->
                            ...
                            <div class="col-md-8">
                                ...
                                <p class="form-control-static">
                                    @if ($inventory->last_audit_date)
                                        {{ Helper::getFormattedDateObject($inventory->last_audit_date, 'datetime', false) }}
                                    @else
                        ...
                        <div class="form-group{{ $errors->has('note') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <textarea class="col-md-6 form-control" id="note" name="note">{{ old('note', $inventory->note) }}</textarea>
