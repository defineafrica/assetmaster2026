                    ...
                    <div class="col-md-12"><!-- .col-md-12 -->
                        ...
                        @if ($backto == 'user')
                            <form class="form-horizontal" method="post"
                                  action="{{ route('inventories.checkin.store', array('inventoryId'=> $inventory->id, 'backto'=>'user')) }}"
                                  autocomplete="off">
                                @else
                                    <form class="form-horizontal" method="post"
                                          action="{{ route('inventories.checkin.store', array('inventoryId'=> $inventory->id)) }}"
                                          autocomplete="off">
                                        @endif
                                        {{csrf_field()}}
                                        ...
                                        <div class="form-group {{ $errors->has('name') ? 'error' : '' }}">
                                            ...
                                            <div class="col-md-8">
                                                <input class="form-control" type="text" name="name" aria-label="name"
                                                       id="name" value="{{ old('name', $inventory->name) }}"/>
                                        ...
                                        <x-input.location-select
                                            ...
                                            name="location_id"
                                            :help_text="($inventory->defaultLoc) ? trans('general.checkin_to_diff_location', ['default_location' => $inventory->defaultLoc->name]) : null"
