                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table
                                    ...
                                    data-columns="{{ \App\Presenters\InventoryAuditPresenter::dataTableLayout() }}"
                                    ...
                                    data-url="{{ route('api.inventories.list-upcoming', ['action' => 'audits', 'upcoming_status' => 'due']) }}"
                                    data-export-options='{
                                        "fileName": "export-inventories-due-audit-{{ date('Y-m-d') }}",
                        ...
                        <div class="row">
                                <div class="col-md-12">
                                    <table
                                        ...
                                        class="table table-striped snipe-table"
                                        data-url="{{ route('api.inventories.list-upcoming', ['action' => 'audits', 'upcoming_status' => 'overdue']) }}"
                                        data-export-options='{
            "fileName": "export-inventories-overdue-audit-{{ date('Y-m-d') }}",
            "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
            }'>
                                    </table>
                                </div> <!-- end col-md-12 -->
