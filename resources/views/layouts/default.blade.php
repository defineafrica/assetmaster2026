            ...
            <footer class="main-footer hidden-print" style="display:grid;flex-direction:column;">
                ...
                <div class="hidden-xs pull-left">
                    <div class="pull-left footer-links">
                        ...
                        <a target="_blank" href="https://github.com/grokability/assetmaster/" rel="noopener" data-tooltip="true" data-title="Join us on Github">
                    ...
                    @if ($snipeSettings->support_footer!='off')
                        @if (($snipeSettings->support_footer=='on') || (($snipeSettings->support_footer=='admin') && (Auth::user()->isSuperUser()=='1')))
                            <a target="_blank" class="label label-default"
                               href="https://assetmaster.readme.io/docs/overview"
