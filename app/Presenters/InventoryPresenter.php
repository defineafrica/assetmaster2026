...
class InventoryPresenter extends Presenter
{
    ...
    {
        if (auth()->user()->can('view', ['\App\Models\Inventory', $this])) {
            return (string)link_to_route('inventories.show', e($this->display_name), $this->id);
        } else {
    ...
    public function fullName()
    {
        ...
        if ($this->inventory_tag) {
            $str .= ' #'.$this->model->inventory_tag;
        }
