...
/**
 * SnipePermissionsPolicy provides methods for handling the granular permissions used throughout AssetMaster.
...
abstract class SnipePermissionsPolicy
{
    ...
    public function before(User $user, $ability, $item)
    {
         ...
         *
         * @see https://assetmaster.readme.io/docs/permissions
         */
