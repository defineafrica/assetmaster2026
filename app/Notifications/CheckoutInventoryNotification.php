...
class CheckoutInventoryNotification extends Notification
{
    use Queueable;
     ...
     * @param $params
     */
    public function __construct(Inventory $inventory, $checkedOutTo, User $checkedOutBy, $acceptance, $note)
    {
    ...
    public function toSlack() :SlackMessage
    {
        ...
        return (new SlackMessage)
            ->content(':arrow_up: :computer: '.trans('mail.Inventory_Checkout_Notification', ['tag' => '']))
            ->from($botname)
            ->to($channel)
    ...
    public function toMicrosoftTeams()
    {
        ...
        if(!Str::contains(Setting::getSettings()->webhook_endpoint, 'workflows')) {
            return MicrosoftTeamsMessage::create()
                ...
                ->type('success')
                ->title(trans('mail.Inventory_Checkout_Notification', ['tag' => '']))
        ...
        $message = trans('mail.Inventory_Checkout_Notification', ['tag' => '']);
        $details = [
            trans('mail.assigned_to') => $target->present()->name,
            trans('mail.inventory') => htmlspecialchars_decode($item->display_name),
...
public function toGoogleChat()
    {
        ...
        return GoogleChatMessage::create()
            ...
            ->card(
                Card::create()
                    ->header(
                        '<strong>'.trans('mail.Inventory_Checkout_Notification', ['tag' => '']).'</strong>' ?: '',
