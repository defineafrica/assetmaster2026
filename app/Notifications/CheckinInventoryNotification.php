...
class CheckinInventoryNotification extends Notification
{
    use Queueable;
    ...
    public function toSlack()
    {
        ...
        return (new SlackMessage)
            ->content(':arrow_down: :computer: '.trans('mail.Inventory_Checkin_Notification', ['tag' => '']))
            ->from($botname)
            ->to($channel)
    ...
    public function toMicrosoftTeams()
    {
        ...
        if(!Str::contains(Setting::getSettings()->webhook_endpoint, 'workflows')) {
            return MicrosoftTeamsMessage::create()
                ...
                ->type('success')
                ->title(trans('mail.Inventory_Checkin_Notification', ['tag' => '']))
        ...
        $message = trans('mail.Inventory_Checkin_Notification', ['tag' => '']);
        $details = [
    ...
    public function toGoogleChat()
    {
        ...
        return GoogleChatMessage::create()
            ...
            ->card(
                Card::create()
                    ->header(
                        '<strong>'.trans('mail.Inventory_Checkin_Notification', ['tag' =>'']).'</strong>' ?: '',
                    ...
                    ->section(
                        Section::create(
                            KeyValue::create(
                                ...
                                ->onClick(route('inventories.show', $item->id))
                        )
                    )
            );
    }
