<?php
/*! \mainpage AssetMaster Code Documentation
 *
 * \section intro_sec Introduction
 *
 * This documentation is designed to allow developers to easily understand
 * the backend code of AssetMaster. Familiarity with the PHP language is assumed,
 ...
 * [Installation documentation](https://assetmaster.readme.io) for
 * information on how to install AssetMaster.
 *
 * To learn how to set up a development environment and get started developing for AssetMaster,
 * please see the [contributing documentation](https://assetmaster.readme.io/docs/contributing-overview).
 *
 * Only the AssetMaster specific controllers, models, helpers, service providers,
