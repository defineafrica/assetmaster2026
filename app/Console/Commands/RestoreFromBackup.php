...
class RestoreFromBackup extends Command
{
     ...
     * @var string
     */
    protected $description = 'Restore from a previously created AssetMaster backup file';
    ...
    public function handle()
    {
        ...
        if (strpos($sqlfiles[0], 'db-dumps') === false) {
            ...
            //older AssetMaster installs don't have the db-dumps subdirectory component
        }
