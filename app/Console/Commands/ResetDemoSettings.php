...
class ResetDemoSettings extends Command
{
     ...
     * @var string
     */
    protected $description = 'This will reset the AssetMaster demo settings back to default. ';
    ...
    public function handle()
    {
        ...
        $settings->site_name = 'AssetMaster Asset Management Demo';
        $settings->auto_increment_assets = 1;
        $settings->logo = 'snipe-logo.png';
        $settings->alert_email = 'service@assetmaster.io';
